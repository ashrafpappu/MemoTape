...
import com.example.pappu.memotape.datamodel.GLLocationData;
import com.example.pappu.memotape.helper.GLHelper;
...
public class PreviewRenderer {
    ...
    void intitPreviewShader(){
        shaderProgram = GLHelper.getShaderProgramm(context, R.raw.preview_vertex_shader, R.raw.preview_fragment_shader);
